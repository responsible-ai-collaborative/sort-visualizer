export function PivotSection() {
  return (
    <section
      ...
      className="w-full min-h-screen flex items-center py-28 my-12 text-white"
      style={{ background: "var(--bg-deep)" }}
      aria-label="Pivot to autonomous vehicles case study"
    >
      <div className="mx-auto max-w-[760px] px-6 sm:px-8 text-center">
        <div className="font-mono text-[10px] uppercase tracking-[0.22em] text-white/70 mb-5">
          Same framework · Different case · Different verdict
        </div>
        <h2 className="font-display text-[34px] sm:text-[42px] leading-[1.1] tracking-[-0.012em] mb-5">
          AV crashes are rising too. Why does the framework call them{" "}
          <em className="italic text-white/90">mitigating</em>?
        </h2>
        <p className="font-body text-[17px] leading-[1.6] text-white/85">
